"""DreamWaq task configuration.

This module provides a factory function to create a base DreamWaq task config.
...
def make_dreamwaq_env_cfg() -> ManagerBasedRlEnvCfg:
  """Create base DreamWaq task configuration."""
  ...
  actor_terms = {
    ...
    # DreamWaq features: estimated velocity (3D) + context vector (16D)
    "cenet_features": ObservationTermCfg(
      func=mdp.cenet_features,
      params={"history_length": 5},  # will be passed to runner
      scale=1.0,
    ),
  }
  ...
  commands: dict[str, CommandTermCfg] = {
    "twist": UniformVelocityCommandCfg(
      ...
      ranges=UniformVelocityCommandCfg.Ranges(
        lin_vel_x=(-0.5, 1.5),   # Adjusted for rough terrain
        lin_vel_y=(-0.5, 0.5),
        ang_vel_z=(-1.0, 1.0),
